...
Read `.octopus/2026-07-28-blob-storage/ledger.md` (the single scoreboard; it carries all necessary history) and `.octopus/2026-07-28-blob-storage/directives.md` if it exists. Then reconcile the working tree: run `pytest tests/test_storage.py -q`; if green, continue where the ledger points; if red, fix the gate first. Never reset / stash / clean work you didn't create.
...
1. Read `.octopus/2026-07-28-blob-storage/ledger.md` + `.octopus/2026-07-28-blob-storage/directives.md`; pick the single smallest unclosed item. One item per round.
